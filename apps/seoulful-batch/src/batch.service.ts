...
import { Member } from 'apps/seoulful-api/src/libs/dto/member/member';
import { Property } from 'apps/seoulful-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/seoulful-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/seoulful-api/src/libs/enums/property.enum';
...
export class BatchService {
	...
	public getHello(): string {
		return 'Welcome to seoulful BATCH Server!';
	}
}
